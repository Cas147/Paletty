        ...
        <Layout>
          ...
          <section className="carousel w-screen flex flex-wrap justify-center mb-8">
            <div className="max-w-sm  m-4 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <a href="#">
                    <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Random</h5>
                </a>
                <p className="mb-3 my-4 font-normal text-gray-500 dark:text-gray-400">Create awesome color palettes generated by AI </p>
                <div 
                  onClick={() => {
            ...
            <div className="max-w-sm m-4 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <a href="#">
                    <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Color list</h5>
                </a>
                <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">Get inspired by our color list with +600 colors, and create a nice palette</p>
            ...
            <div className="max-w-sm m-4 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <a href="#">
                    <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Image</h5>
                </a>
                <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">Upload an image, and our Ai will create a awesome color palette</p>
                <Link href="/Image" className="inline-flex items-center text-blue-600 hover:underline">
